...
SETTING_GROUPS = [
    ...
    },
    {
        ...
        "keys": [
            ...
            "SEERR_URL", "SEERR_API_KEY", "SEERR_REPORT_STATUS", "SEERR_DECLINE_WANTED_AFTER_DAYS",
            "TMDB_API_KEY",
            "DEBRIDIO_ENABLED", "DEBRIDIO_API_KEY", "DEBRIDIO_BASE_URL",
            "DEBRIDIO_MAX_RESULTS", "DEBRIDIO_CONFIG_TOKEN",
            "TRAKT_CLIENT_ID", "TRAKT_CLIENT_SECRET", "TRAKT_AUTO_REQUEST_CAP",
    ...
    },
    {
        ...
        "keys": ["CATBOX_MODE", "CATBOX_LAZY_ADD", "CATBOX_PRELOAD", "CATBOX_HOST", "CATBOX_IDLE_MINUTES", "CATBOX_GC_INTERVAL_MINUTES", "DISK_SYNC_ENABLED"],
    },
    {
