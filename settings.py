...
SECTIONS = [
    ...
    },
    {
        ...
        "fields": [
            ...
            _f("TRUSTED_PROXY_NETWORKS", "Trusted networks", "Only requests from these networks (CIDR, comma separated) may carry that header; also decides which forwarded address the login rate limiter keys on.",
               placeholder="127.0.0.1/32,10.0.0.0/8", advanced=True),
