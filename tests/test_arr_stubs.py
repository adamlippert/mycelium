...
def test_fixed_mode_auto_upgrade_stores_the_release_label_not_the_scraper_name(monkeypatch):
    ...
    monkeypatch.setattr(torbox, "add_magnet", lambda account_id, magnet, reason=None: None)
    monkeypatch.setattr(torbox, "wait_until_ready", lambda account_id, info_hash: {"id": "tb1"})
